...
def show_instructions():
    print("=" * 70)
    print("📧 GMAIL APP PASSWORD - STEP BY STEP GUIDE")
    print("=" * 70)
    print()
    print("⚠️  IMPORTANT: You CANNOT use your regular Gmail password!")
    ...
    print("✅ Opened: https://myaccount.google.com/security")
    print()
    print("⏳ Please enable 2-Factor Authentication first...")
    print()
    ...
    print()
    print("📋 YOU WILL SEE A 16-CHARACTER PASSWORD LIKE:")
...
def manual_instructions():
    print()
    print("=" * 70)
    print("📖 MANUAL INSTRUCTIONS (If browser didn't open)")
    print("=" * 70)
    print()
    print("Step 1: Enable 2-Factor Authentication")
